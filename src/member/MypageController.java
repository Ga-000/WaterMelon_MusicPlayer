...
public class MypageController implements Initializable {
	...
	@FXML
	private PasswordField pw, regPW;
	@FXML
	private Button loginBtn, regCancel, regBtn, memUpdate, memDelete;
	@FXML
	private Label myP, nameLabel;

	@FXML
	private ComboBox<String> regAge;
	@FXML
	private HBox nameBox, userId, userAge;

	private ObservableList<Node> la;
	private ArrayList<MemberDTO> useridlist;
	private ArrayList<MemberDTO> memlist;

	private Stage stage, myStage;
