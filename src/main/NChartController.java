...
//	}
	...
	@FXML
	private Label myP, logIN;
	@FXML
	private TextField id, regID, regName;
	@FXML
	private PasswordField pw, regPW, currentPW, newPW;
	@FXML
	private Button loginBtn, regCancel, regBtn, memUpdate, memDelete, upCancelBtn, upBtn;

	@FXML
	private ComboBox<String> regAge;
	@FXML
	private HBox nameBox, footerBar;
	@FXML
	...
	// 위쪽 페이지 이동 버튼
	private Parent NhomePage, NrecentPage, NpopularPage, regForm, updateForm;
	private Stage regStage, updateStage;
