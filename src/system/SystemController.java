...
//		fileChooser.setInitialDirectory(new File("C:\\Users\\82104\\git\\watermelon\\music\\"));
		fileChooser.setInitialDirectory(new File("C:\\javas\\java-workspace\\waterMelon\\music\\"));
		// 파일 옵션 표시
...
//			File saveFile = new File("C:\\Users\\82104\\git\\watermelon\\musicList\\" + chooseFile.getName()); // 저장 경로
			File saveFile = new File("C:\\javas\\java-workspace\\waterMelon\\musicList\\" + chooseFile.getName()); // 저장 경로
...
//		fileChooser.setInitialDirectory(new File("C:\\Users\\82104\\git\\watermelon\\musicList\\"));
		fileChooser.setInitialDirectory(new File("C:\\javas\\java-workspace\\waterMelon\\music\\"));
		// 파일 옵션 표시
		fileChooser.getExtensionFilters().addAll(new ExtensionFilter("음악파일 : Audio Files(*.mp3)", "*.mp3"));
